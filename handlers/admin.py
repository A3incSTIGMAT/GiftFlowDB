...
# Временное хранилище для ожидания добавления подарка
waiting_for_gift = {}
...
async def handle_add_gift(message: types.Message):
    ...
    if message.from_user.id not in waiting_for_gift:
        return
    ...
    try:
        # Парсим сообщение: Название | Цена | Описание | Иконка
